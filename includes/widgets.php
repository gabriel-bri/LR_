	...
	public function widget( $args, $instance ) {
		...
		<div class="widget_content">
			...
			foreach ( $tweets as $tweet ) {
				...
				$ago_text = sprintf( esc_html__( '%s atrás', 'extra' ), human_time_diff( strtotime( $date ) ) );
			...
			<li>
				...
				<div class="post-tweet">
					<?php echo $tweet->text; ?>
					<div class="post-meta">
						<?php echo esc_html( $ago_text ); ?> • <a href="<?php echo esc_url( $reply_link ); ?>" target="_blank"><?php esc_html_e( 'Responder', 'extra' ); ?></a> • <a href="<?php echo esc_url( $retweet_link ); ?>" target="_blank"><?php esc_html_e( 'Retweet', 'extra' ); ?></a> • <a href="<?php echo esc_url( $favorite_link ); ?>"target="_blank"><?php esc_html_e( 'Favorito', 'extra' ); ?></a>
					</div>
				</div>
			</li>
			<?php } ?>
