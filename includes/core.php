...
function extra_load_scripts_styles(){
	...
	wp_localize_script( 'extra-scripts', 'EXTRA', array(
		...
		'error'                        => esc_html__( 'Alguns problemas estão acontecendo, por favor, tente novamente.', 'extra' ),
		'contact_error_name_required'  => esc_html__( 'O campo nome não pode está vazio', 'extra' ),
		'contact_error_email_required' => esc_html__( 'O campo de e-mail não pode está vazio', 'extra' ),
		'contact_error_email_invalid'  => esc_html__( 'Por favor coloque um e-mail válido', 'extra' ),
...
function extra_add_mobile_navigation(){
	printf(
		...
		esc_html__( 'Selecione a página', 'extra' )
	);
}
