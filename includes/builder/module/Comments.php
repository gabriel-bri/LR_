...
class ET_Builder_Module_Comments extends ET_Builder_Module {
	function init() {
		$this->name       = esc_html__( 'Comentários', 'et_builder' );
		...
		$this->options_toggles = array(
			...
			'advanced' => array(
				'toggles' => array(
					'text' => array(
						'title'    => esc_html__( 'Texto', 'et_builder' ),
						'priority' => 49,
					),
				),
			),
		...
		$this->advanced_options = array(
			...
			'fonts' => array(
				'body' => array(
					'label'          => esc_html__( 'Comentário', 'et_builder' ),
					'css'            => array(
				...
				'form_field' => array(
					'label'          => esc_html__( 'Campo', 'et_builder' ),
					'css'            => array(
			...
			'border' => array(
				'label'    => esc_html__( 'Borda dos campos', 'et_builder' ),
				'css'      => array(
			...
			'button' => array(
				'button' => array(
					'label' => esc_html__( 'Botão', 'et_builder' ),
					'css' => array(
	...
	function et_pb_comments_submit_button( $submit_button ) {
		return sprintf(
			...
			esc_attr( 'submit' ),
			esc_html__( 'Postar Comentário', 'et_builder' )
		);
	}
