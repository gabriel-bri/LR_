	...
	static function get_blog_posts( $args = array(), $conditional_tags = array(), $current_page = array(), $is_ajax_request = true ) {
		...
		if ( $query->have_posts() ) {
			...
			while ( $query->have_posts() ) {
				...
				$query->posts[ $post_index ]->post_comment_popup  = sprintf( esc_html( _nx( '%s Comentários', '%s Comentários', get_comments_number(), 'número de comentários', 'et_builder' ) ), number_format_i18n( get_comments_number() ) );
