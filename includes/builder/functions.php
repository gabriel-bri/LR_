...
if ( ! defined( 'ET_BUILDER_PRODUCT_VERSION' ) ) {
	...
	define( 'ET_BUILDER_PRODUCT_VERSION', '3.0.82' );
}
...
function et_fb_current_page_params() {
	...
	$current_page = array(
		...
		'authorUrlTitle'           => sprintf( esc_html__( 'Posts por %s', 'et_builder' ), get_the_author() ),
...
function et_pb_get_comments_popup_link( $zero = false, $one = false, $more = false ){
	...
	elseif ( $number == 0 )
		...
		$output = ( false === $one ) ? __( '1 Comentário', 'et_builder' ) : $one;
