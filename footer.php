	<footer id="footer1" class="footer_columns_3">
		<div id="footer-bottom">
			<div class="container">
				<!-- Footer Info -->
				<p id="footer-info">&copy; 2014 - <?php echo date("Y");?> <a href="http://cryptoroot.com.br">Lovers of the Road</a>. Todos os direitos reservados</p>
				...
				<div id="footer-nav">
					<ul class="et-extra-social-icons" style="">
						...
						<li class="et-extra-social-icon instagram"><a href="https://instagram.com/CryptoRootOfficial" class="et-extra-icon et-extra-icon-background-none et-extra-icon-instagram" target="_blank"></a></li>
			...
			$('section').mousemove(function(e) {
				// body...
			var MoverX = (e.pageX * -1 / 10);
			var MoverY = (e.pageX * -1 / 10);
			$(this).css('background-position', MoverX + 'px ' + MoverY + 'px')
			})
		</script>
